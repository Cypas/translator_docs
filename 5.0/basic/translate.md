...
!>建议多花一点时间去注册至少一个私人翻译接口，体验会好很多,首要推荐是[腾讯翻译](/5.0/basic/translate#腾讯翻译接口)
...
- 劣势:有一定兼容性问题，如果电脑装有[chrome](https://www.google.cn/chrome/index.html)/[firefox](https://www.mozilla.org/zh-CN/firefox/)/[edge](https://www.microsoft.com/zh-cn/edge)三种主流浏览器中至少一种，启动时仍是显示公共翻译启动失败-->查看[公共翻译启动失败](/5.0/FAQ/faq#公共翻译启动失败)
