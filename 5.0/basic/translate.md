## 公共翻译的说明
!>5.0版本中已移除旧版本中的`公共翻译`，其稳定性太差已不再支持，请花一定时间注册以下至少一种`私人`翻译源，确保稳定的翻译体验，大部分私人翻译也都有很多免费额度，正常情况上用不完的
...
|腾讯|500w字符/月|⭐⭐⭐⭐|⭐⭐⭐||
|百度|100w字符/月|⭐⭐⭐⭐|⭐⭐⭐||
|gpt|gpt3.5模型为1千万tokens/5美元|⭐⭐⭐|⭐⭐⭐⭐⭐|最强翻译源，注册较麻烦，耗时比较高，不太适用于实时翻译，更适合图片翻译|
|tgw本地翻译|不限次数|⭐⭐⭐|⭐⭐⭐⭐⭐|部署难度较高，需要花较多精力，对显卡要求很高(6G显存及以上)| 
|阿里|100w字符/每月|⭐⭐⭐|⭐⭐⭐||
|彩云|`一次性`100w字符|⭐⭐|⭐⭐⭐⭐|在翻译二次元相关内容时表现较好|
|有道|`一次性`约120w字符|⭐⭐|⭐⭐⭐||
|团子|购买漫画or在线ocr服务时间内不限次数|⭐⭐|⭐⭐|不需要任何注册，打开开关就能使用，但翻译效果不如其他翻译源|
